...
function make_mice(data)
    ...
    mouse_1 = v3Info("mouse_1", size(data["mouse1_day1"])[2] , 101   , 1-0.2775  ,   1 - 0.3927, data["mouse1_day1"])
    mouse_3 = v3Info("mouse_3", size(data["mouse3_day1"])[2] , 114   , 1-0.1745 ,   1 - 0.2752, data["mouse3_day1"])
    mouse_4 = v3Info("mouse_4", size(data["mouse4_day1"])[2] , 146   , 1-0.1207  ,   1 - 0.1760, data["mouse4_day1"])
    mouse_5 = v3Info("mouse_5", size(data["mouse5_day1"])[2] , 112   , 1-0.3208  ,   1 - 0.5722, data["mouse5_day1"])
